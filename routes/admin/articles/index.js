...
router.get('/',async ctx => {
    ...
    let columnName = '`id`,`title`,`uid`,`create_time`,`common_num`,`praise_num`,`update_time`,`comon_status`,`cid`'

    let count = await DB.count('articles', 'title', search)
    let data = await DB.find('articles', columnName, 'title', search, skips, limits)
